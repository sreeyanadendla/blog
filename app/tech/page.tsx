          ...
          <div className="bg-gray-900 rounded-lg overflow-hidden hover:bg-gray-800 transition-colors cursor-pointer">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-400 font-light text-sm leading-relaxed mb-4">
                My thoughts on building this website. No filters, just the real, raw thoughts.
              </p>
              <div className="flex space-x-4">
                <Link href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-rose-300 hover:text-rose-200 transition-colors">
