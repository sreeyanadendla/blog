      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <nav className="flex justify-between items-center p-6 border-b border-gray-800">
          ...
          <div className="flex items-center space-x-8">
            ...
            <a href="/tech" className="text-rose-300 font-light tracking-wide">Tech</a>
            <a href="/other" className="text-white hover:text-rose-300 transition-colors font-light tracking-wide">Other</a>
